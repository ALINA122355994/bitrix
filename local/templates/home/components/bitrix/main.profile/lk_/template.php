...
<div class="row form-group">
  ...
  <span class="font-weight-bold">EMAIL</span>
	<input type="text" name="EMAIL" maxlength="50" value="<? echo $arResult["arUser"]["EMAIL"]?>" class="form-control" placeholder="<?=$arResult["arUser"]["EMAIL"]?>">
            ...
            <div class="row form-group">
			<div class="col-md-12">
			<label class="font-weight-bold" for="PROFESSION"><?=GetMessage('USER_PROFESSION')?></label>
			<input type="text"   name="PERSONAL_PROFESSION" class="form-control" value="<?=$arResult["PERSONAL_PROFESSION"]?>" placeholder="<?=$arResult["PERSONAL_PROFESSION"]?>">
 			 </div>
			</div>
