		...
		<figure> <img alt="Image" src="<?=$arItem["PREVIEW_PICTURE"]["SRC"]?>" class="img-fluid"> 
					...
					<div class="prop-text">
						...
						<div class="inner d-flex">
										<div class="col">
										<?=GetMessage('AREA')?></br> <?=$arItem["PROPERTY_TOTAL_AREA_VALUE"]?>
										</div>
										<div class="col">
										<?=GetMessage('BEDS')?></br> <?=$arItem["PROPERTY_NUMBER_BEDROOMS_VALUE"]?>
										</div>
										<div class="col">
										<?=GetMessage('BATHS')?></br> <?=$arItem["PROPERTY_NUMBER_BATHROOMS_VALUE"]?>
										</div>
										<div class="col">
										<?=GetMessage('GARAGES')?> </br><?if($arItem["PROPERTY_PRESENCE_GARAGE_VALUE"]):?>
